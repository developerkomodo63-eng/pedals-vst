...
juce::AudioProcessorValueTreeState::ParameterLayout OverdriveBassAudioProcessor::createParameterLayout()
{
    ...
    params.push_back(std::make_unique<juce::AudioParameterFloat>(
        juce::ParameterID { "TONE", 1 }, "Tone", 600.0f, 5000.0f, 2500.0f));
...
OverdriveBassAudioProcessor::OverdriveBassAudioProcessor()
...
void OverdriveBassAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void OverdriveBassAudioProcessor::releaseResources()
{
}

bool OverdriveBassAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
float OverdriveBassAudioProcessor::processSaturationSample (float x) noexcept
{
...
void OverdriveBassAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* OverdriveBassAudioProcessor::createEditor()
{
    return new juce::GenericAudioProcessorEditor(*this);
}

void OverdriveBassAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void OverdriveBassAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new OverdriveBassAudioProcessor();
}
