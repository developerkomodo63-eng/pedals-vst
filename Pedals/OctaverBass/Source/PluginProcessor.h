...
class OctaverBassAudioProcessor : public juce::AudioProcessor
{
public:
    OctaverBassAudioProcessor();
    ~OctaverBassAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OctaverBassAudioProcessor)
};
