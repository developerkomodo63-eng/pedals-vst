...
class ChorusBassAudioProcessor : public juce::AudioProcessor
{
public:
    ChorusBassAudioProcessor();
    ~ChorusBassAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ChorusBassAudioProcessor)
};
