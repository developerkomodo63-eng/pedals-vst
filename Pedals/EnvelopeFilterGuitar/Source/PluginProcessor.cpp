...
juce::AudioProcessorValueTreeState::ParameterLayout EnvelopeFilterGuitarAudioProcessor::createParameterLayout()
{
...
EnvelopeFilterGuitarAudioProcessor::EnvelopeFilterGuitarAudioProcessor()
...
void EnvelopeFilterGuitarAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void EnvelopeFilterGuitarAudioProcessor::releaseResources()
{
}

bool EnvelopeFilterGuitarAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void EnvelopeFilterGuitarAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* EnvelopeFilterGuitarAudioProcessor::createEditor()
{
    return new juce::GenericAudioProcessorEditor(*this);
}

void EnvelopeFilterGuitarAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void EnvelopeFilterGuitarAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new EnvelopeFilterGuitarAudioProcessor();
}
