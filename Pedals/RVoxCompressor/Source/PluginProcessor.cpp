...
juce::AudioProcessorValueTreeState::ParameterLayout RVoxCompressorAudioProcessor::createParameterLayout()
{
...
RVoxCompressorAudioProcessor::RVoxCompressorAudioProcessor()
...
void RVoxCompressorAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void RVoxCompressorAudioProcessor::releaseResources()
{
}

bool RVoxCompressorAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void RVoxCompressorAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* RVoxCompressorAudioProcessor::createEditor()
{
    return new juce::GenericAudioProcessorEditor(*this);
}

void RVoxCompressorAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void RVoxCompressorAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new RVoxCompressorAudioProcessor();
}
