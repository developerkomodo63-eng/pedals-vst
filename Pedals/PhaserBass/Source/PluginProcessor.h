...
class PhaserBassAudioProcessor : public juce::AudioProcessor
{
public:
    PhaserBassAudioProcessor();
    ~PhaserBassAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PhaserBassAudioProcessor)
};
