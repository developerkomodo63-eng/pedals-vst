...
juce::AudioProcessorValueTreeState::ParameterLayout BritpopDriveAudioProcessor::createParameterLayout()
{
...
BritpopDriveAudioProcessor::BritpopDriveAudioProcessor()
...
void BritpopDriveAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void BritpopDriveAudioProcessor::releaseResources()
{
}

bool BritpopDriveAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
float BritpopDriveAudioProcessor::processSaturationSample (float x) noexcept
{
...
void BritpopDriveAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* BritpopDriveAudioProcessor::createEditor()
{
    return new juce::GenericAudioProcessorEditor(*this);
}

void BritpopDriveAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void BritpopDriveAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new BritpopDriveAudioProcessor();
}
