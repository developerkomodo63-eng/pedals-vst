...
juce::AudioProcessorValueTreeState::ParameterLayout OctaverGuitarAudioProcessor::createParameterLayout()
{
...
OctaverGuitarAudioProcessor::OctaverGuitarAudioProcessor()
...
void OctaverGuitarAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void OctaverGuitarAudioProcessor::releaseResources()
{
}

bool OctaverGuitarAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void OctaverGuitarAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* OctaverGuitarAudioProcessor::createEditor()
{
    return new juce::GenericAudioProcessorEditor(*this);
}

void OctaverGuitarAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void OctaverGuitarAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new OctaverGuitarAudioProcessor();
}
