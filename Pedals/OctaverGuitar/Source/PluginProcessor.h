...
class OctaverGuitarAudioProcessor : public juce::AudioProcessor
{
public:
    OctaverGuitarAudioProcessor();
    ~OctaverGuitarAudioProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OctaverGuitarAudioProcessor)
};
